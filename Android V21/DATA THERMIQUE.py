...
if __name__ == "__main__":
    while True:
            for i in range(32):
                            pix[i] = random.randint(18, 35)  # Remplace 22 par une valeur aléatoire
                            pix[i + 32] = random.randint(18, 35)  # Remplace 25 par une valeur aléatoire
                            pix[i + 64] = random.randint(18, 35)  # Remplace 28 par une valeur aléatoire
                            pix[i + 96] = random.randint(18, 35)  # Remplace 19 par une valeur aléatoire
